...
if (dineroCofla >= 0.6 && dineroCofla<1) {
    ...
    alert('Cofla, comprate el helado con confetis o el pote de 1/4kg');
    alert('y te sobran ' + (dineroCofla-2.9));
}
else { 
    alert('Lo siento Cofla no te alcanza el dinero')
}
...
if (dineroRoberto >= 0.6 && dineroRoberto<1) {
    ...
    alert('Roberto, comprate el helado con confetis o el pote de 1/4kg');
}
else { 
    alert('Lo siento roberto no te alcanza el dinero')
}
...
if (dineroPedro >= 0.6 && dineroPedro<1) {
    ...
    alert('Pedro comprate el helado con confetis o el pote de 1/4kg');
}
else { 
    alert('Lo siento pedro no te alcanza el dinero')
}